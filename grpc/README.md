...
### See files
- Cargo.toml // extra needed deps
- definition/gcl.yaml // configuration definition
- proto/example.proto // grpc service definition
- src/lib.rs // include the proto && client usage
- build.rs // compilation of proto files
